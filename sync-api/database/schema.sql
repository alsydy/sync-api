...
-- ============================================================================
-- 18. جدول سياسات الخصوصية (privacy_policies) وبنودها
-- ============================================================================
...
-- Indexes for privacy policy tables
...
COMMENT ON TABLE privacy_policies IS 'سياسات الخصوصية المنشورة للتطبيق';
COMMENT ON TABLE privacy_policy_items IS 'بنود سياسة الخصوصية المرتبطة بكل سياسة';
COMMENT ON TABLE privacy_policy_acceptances IS 'سجل موافقات المستخدمين على سياسات الخصوصية';
